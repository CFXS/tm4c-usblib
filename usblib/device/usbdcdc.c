...
//
//*****************************************************************************
#define RX_BLOCK_OPS ((1 << CDC_DO_SEND_BREAK) | (1 << CDC_DO_LINE_CODING_CHANGE) | (1 << CDC_DO_LINE_STATE_CHANGE))
...
//
//*****************************************************************************
#define USB_CDC_SERIAL_ERRORS (USB_CDC_SERIAL_STATE_OVERRUN | USB_CDC_SERIAL_STATE_PARITY | USB_CDC_SERIAL_STATE_FRAMING)
...
const tConfigSection g_sCDCSerConfigSection = {sizeof(g_pui8CDCSerDescriptor), g_pui8CDCSerDescriptor};
...
const tConfigSection g_sIADSerConfigSection = {sizeof(g_pui8IADSerDescriptor), g_pui8IADSerDescriptor};
...
const tConfigSection g_sCDCSerCommInterfaceSection = {sizeof(g_pui8CDCSerCommInterface), g_pui8CDCSerCommInterface};
...
const tConfigSection g_sCDCSerDataInterfaceSection = {sizeof(g_pui8CDCSerDataInterface), g_pui8CDCSerDataInterface};
...
const tConfigSection g_sCDCSerDataInterfaceSectionHS = {sizeof(g_pui8CDCSerDataInterfaceHS), g_pui8CDCSerDataInterfaceHS};
...
#define NUM_CDCSER_SECTIONS (sizeof(g_psCDCSerSections) / sizeof(g_psCDCSerSections[0]))
...
//
//*****************************************************************************
const tConfigHeader g_sCDCSerConfigHeader = {NUM_CDCSER_SECTIONS, g_psCDCSerSections};

const tConfigHeader g_sCDCSerConfigHeaderHS = {NUM_CDCSER_SECTIONS, g_psCDCSerSectionsHS};
...
#define NUM_COMP_CDCSER_SECTIONS (sizeof(g_psCDCCompSerSections) / sizeof(g_psCDCCompSerSections[0]))
...
//
//*****************************************************************************
const tConfigHeader g_sCDCCompSerConfigHeader = {NUM_COMP_CDCSER_SECTIONS, g_psCDCCompSerSections};

const tConfigHeader g_sCDCCompSerConfigHeaderHS = {NUM_COMP_CDCSER_SECTIONS, g_psCDCCompSerSectionsHS};
...
//
//*****************************************************************************
const tConfigHeader *const g_ppCDCSerConfigDescriptors[] = {&g_sCDCSerConfigHeader};

const tConfigHeader *const g_ppCDCSerConfigDescriptorsHS[] = {&g_sCDCSerConfigHeaderHS};
...
//
//*****************************************************************************
const tConfigHeader *const g_pCDCCompSerConfigDescriptors[] = {&g_sCDCCompSerConfigHeader};

const tConfigHeader *const g_pCDCCompSerConfigDescriptorsHS[] = {&g_sCDCCompSerConfigHeaderHS};
...
static void HandleDevice(void *pvCDCDevice, uint32_t ui32Request, void *pvRequestData);
...
//
//*****************************************************************************
static bool DeviceConsumedAllData(const tUSBDCDCDevice *psCDCDevice) {
    ...
    //
    ui32Remaining = psCDCDevice->pfnRxCallback(psCDCDevice->pvRxCBData, USB_EVENT_DATA_REMAINING, 0, (void *)0);
...
//
//*****************************************************************************
static void SendBreak(tUSBDCDCDevice *psCDCDevice, bool bSend) {
    ...
    //
    psCDCDevice->pfnControlCallback(
        psCDCDevice->pvControlCBData, (bSend ? USBD_CDC_EVENT_SEND_BREAK : USBD_CDC_EVENT_CLEAR_BREAK), 0, (void *)0);
}
...
//
//*****************************************************************************
static void SendLineCodingChange(tUSBDCDCDevice *psCDCDevice) {
    tCDCSerInstance *psInst;
    ...
    //
    SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_LINE_CODING_CHANGE, false);

    //
    // Tell the client to update their serial line coding parameters.
    //
    psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USBD_CDC_EVENT_SET_LINE_CODING, 0, &(psInst->sLineCoding));
}
...
//
//*****************************************************************************
static void SendLineStateChange(tUSBDCDCDevice *psCDCDevice) {
    tCDCSerInstance *psInst;
    ...
    // yet to be notified to the client.
    //
    SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_LINE_STATE_CHANGE, false);

    //
    // Tell the client to update their serial line coding parameters.
    //
    psCDCDevice->pfnControlCallback(
        psCDCDevice->pvControlCBData, USBD_CDC_EVENT_SET_CONTROL_LINE_STATE, psInst->ui16ControlLineState, (void *)0);
}
...
//
//*****************************************************************************
static bool CheckAndSendBreak(tUSBDCDCDevice *psCDCDevice, uint16_t ui16Duration) {
    bool bCanSend;
...
//
//*****************************************************************************
static bool CheckAndSendLineCodingChange(tUSBDCDCDevice *psCDCDevice) {
    bool bCanSend;
...
//
//*****************************************************************************
static bool CheckAndSendLineStateChange(tUSBDCDCDevice *psCDCDevice) {
    bool bCanSend;
...
//
//*****************************************************************************
static bool SendSerialState(tUSBDCDCDevice *psCDCDevice) {
    ...
    //
    SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_SERIAL_STATE_CHANGE, false);
    //
    ...
    //
    sRequest.bmRequestType = (USB_RTYPE_DIR_IN | USB_RTYPE_CLASS | USB_RTYPE_INTERFACE);
    ...
    //
    i32Retcode = MAP_USBEndpointDataPut(psInst->ui32USBBase, psInst->ui8ControlEndpoint, (uint8_t *)&sRequest, sizeof(tUSBRequest));
    i32Retcode = MAP_USBEndpointDataPut(
        psInst->ui32USBBase, psInst->ui8ControlEndpoint, (uint8_t *)&ui16SerialState, USB_CDC_NOTIFY_SERIAL_STATE_SIZE);
    ...
    if (i32Retcode != -1) {
        ...
        // sent.
        //
        i32Retcode = MAP_USBEndpointDataSend(psInst->ui32USBBase, psInst->ui8ControlEndpoint, USB_TRANS_IN);
    }
...
bool ProcessDataFromHost(tUSBDCDCDevice *psCDCDevice, uint32_t ui32Status) {
    ...
    //
    ui32EPStatus = MAP_USBEndpointStatus(psInst->ui32USBBase, psInst->ui8BulkOUTEndpoint);

    //
    // Clear the status bits.
    //
    MAP_USBDevEndpointStatusClear(psInst->ui32USBBase, psInst->ui8BulkOUTEndpoint, ui32EPStatus);
    ...
    if (ui32EPStatus & USB_DEV_RX_PKT_RDY) {
        ...
        if (!psInst->bControlBlocked && !psInst->bRxBlocked) {
            ...
            //
            ui32Size = MAP_USBEndpointDataAvail(psInst->ui32USBBase, psInst->ui8BulkOUTEndpoint);
            ...
            //
            psCDCDevice->pfnRxCallback(psCDCDevice->pvRxCBData, USB_EVENT_RX_AVAILABLE, ui32Size, (void *)0);
        }
    } else {
        //
        ...
        if (ui32EPStatus & USB_RX_ERROR_FLAGS) {
            ...
            //
            psCDCDevice->pfnRxCallback(psCDCDevice->pvRxCBData, USB_EVENT_ERROR, (ui32EPStatus & USB_RX_ERROR_FLAGS), (void *)0);
        }
...
bool ProcessNotificationToHost(tUSBDCDCDevice *psCDCDevice, uint32_t ui32Status) {
    ...
    // Get the endpoint status to see why we were called.
    //
    ui32EPStatus = MAP_USBEndpointStatus(psInst->ui32USBBase, psInst->ui8ControlEndpoint);

    //
    // Clear the status bits.
    //
    MAP_USBDevEndpointStatusClear(psInst->ui32USBBase, psInst->ui8ControlEndpoint, ui32EPStatus);
...
bool ProcessDataToHost(tUSBDCDCDevice *psCDCDevice, uint32_t ui32Status) {
    ...
    // Get the endpoint status to see why we were called.
    //
    ui32EPStatus = MAP_USBEndpointStatus(psInst->ui32USBBase, psInst->ui8BulkINEndpoint);

    //
    // Clear the status bits.
    //
    MAP_USBDevEndpointStatusClear(psInst->ui32USBBase, psInst->ui8BulkINEndpoint, ui32EPStatus);
    ...
    if (psInst->ui16LastTxSize) {
        ...
        //
        bSentFullPacket = (psInst->ui16LastTxSize == g_ui16MaxPacketSize) ? true : false;
        ...
        psCDCDevice->pfnTxCallback(psCDCDevice->pvTxCBData, USB_EVENT_TX_COMPLETE, ui32Size, (void *)0);
        ...
        if (bSentFullPacket && !psInst->ui16LastTxSize) {
            ...
            //
            MAP_USBEndpointDataSend(psInst->ui32USBBase, psInst->ui8BulkINEndpoint, USB_TRANS_IN);
        }
    }
...
static void HandleEndpoints(void *pvCDCDevice, uint32_t ui32Status) {
    ...
    //
    psCDCDeviceInst = (tUSBDCDCDevice *)pvCDCDevice;
...
static void HandleConfigChange(void *pvCDCDevice, uint32_t ui32Info) {
    ...
    if (!psInst->bConnected) {
        ...
        //
        psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_CONNECTED, 0, (void *)0);
    }
    ...
    switch (psInst->ui8PendingRequest) {
        ...
        case USB_CDC_SET_LINE_CODING: {
            if (ui32DataSize != sizeof(tLineCoding)) {
                ...
                //
                SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_LINE_CODING_CHANGE, true);
    ...
    switch (ui32Request) {
        ...
        case USB_EVENT_COMP_EP_CHANGE: {
            ...
            if (pui8Data[0] & USB_EP_DESC_IN) {
                ...
                if ((pui8Data[0] & 0x7f) == USBEPToIndex(CONTROL_ENDPOINT)) {
                    psInst->ui8ControlEndpoint = IndexToUSBEP((pui8Data[1] & 0x7f));
                } else {
                    psInst->ui8BulkINEndpoint = IndexToUSBEP((pui8Data[1] & 0x7f));
                }
            } else {
                //
                // Extract the new endpoint number.
                //
                psInst->ui8BulkOUTEndpoint = IndexToUSBEP(pui8Data[1] & 0x7f);
            }
            break;
        }
        ...
        case USB_EVENT_LPM_RESUME: {
            if (psCDCDevice->pfnControlCallback) {
                ...
                //
                psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_LPM_RESUME, 0, (void *)0);
            }
            break;
        }
        case USB_EVENT_LPM_SLEEP: {
            if (psCDCDevice->pfnControlCallback) {
                ...
                //
                psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_LPM_SLEEP, 0, (void *)0);
            }
            break;
        }
        case USB_EVENT_LPM_ERROR: {
            if (psCDCDevice->pfnControlCallback) {
                ...
                //
                psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_LPM_ERROR, 0, (void *)0);
            }
            break;
        }
        default: {
...
static void HandleRequests(void *pvCDCDevice, tUSBRequest *pUSBRequest) {
    ...
    switch (pUSBRequest->bRequest) {
        ...
        case USB_CDC_SET_LINE_CODING: {
            ...
            //
            USBDCDRequestDataEP0(0, (uint8_t *)&psInst->sLineCoding, sizeof(tLineCoding));
        ...
        case USB_CDC_GET_LINE_CODING: {
            ...
            //
            psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USBD_CDC_EVENT_GET_LINE_CODING, 0, &sLineCoding);
        ...
        case USB_CDC_SET_CONTROL_LINE_STATE: {
            ...
            // state change.
            //
            SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_LINE_STATE_CHANGE, true);
        ...
        case USB_CDC_SEND_BREAK: {
            ...
            //
            SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_SEND_BREAK, true);
...
static void HandleDisconnect(void *pvCDCDevice) {
    ...
    if (psInst->bConnected) {
        ...
        //
        psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_DISCONNECTED, 0, (void *)0);
    }
...
static void HandleSuspend(void *pvCDCDevice) {
    ...
    //
    psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_SUSPEND, 0, (void *)0);
}
...
static void HandleResume(void *pvCDCDevice) {
    ...
    // Pass the event on to the client.
    //
    psCDCDevice->pfnControlCallback(psCDCDevice->pvControlCBData, USB_EVENT_RESUME, 0, (void *)0);
}
...
//
//*****************************************************************************
static void CDCTickHandler(void *pvCDCDevice, uint32_t ui32TimemS) {
    bool bCanSend;
    tUSBDCDCDevice *psCDCDevice;
    tCDCSerInstance *psInst;
    uint32_t ui32Size;
...
void *USBDCDCCompositeInit(uint32_t ui32Index, tUSBDCDCDevice *psCDCDevice, tCompositeEntry *psCompEntry) {
    ...
    // structure.
    //
    psInst->sDevInfo.ppui8StringDescriptors   = psCDCDevice->ppui8StringDescriptors;
    psInst->sDevInfo.ui32NumStringDescriptors = psCDCDevice->ui32NumStringDescriptors;
...
uint32_t USBDCDCPacketWrite(void *pvCDCDevice, uint8_t *pi8Data, uint32_t ui32Length, bool bLast) {
    ...
    //
    if ((ui32Length > g_ui16MaxPacketSize) || (psInst->iCDCTxState != eCDCStateIdle)) {
        //
    ...
    //
    i32Retcode = MAP_USBEndpointDataPut(psInst->ui32USBBase, psInst->ui8BulkINEndpoint, pi8Data, ui32Length);
...
uint32_t USBDCDCPacketRead(void *pvCDCDevice, uint8_t *pi8Data, uint32_t ui32Length, bool bLast) {
    ...
    if (ui32EPStatus & USB_DEV_RX_PKT_RDY) {
        ...
        if (psInst->bRxBlocked || psInst->bControlBlocked) {
            ...
            //
            ui32Pkt = MAP_USBEndpointDataAvail(psInst->ui32USBBase, psInst->ui8BulkOUTEndpoint);

            //
            // Get as much data as we can.
            //
            ui32Count  = ui32Length;
            i32Retcode = MAP_USBEndpointDataGet(psInst->ui32USBBase, psInst->ui8BulkOUTEndpoint, pi8Data, &ui32Count);
            ...
            if (ui32Count == ui32Pkt) {
                ...
                // next packet.
                //
                MAP_USBDevEndpointDataAck(psInst->ui32USBBase, psInst->ui8BulkOUTEndpoint, true);

                //
                // Clear the flag we set to indicate that a packet read is
                // pending.
                //
                SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_PACKET_RX, false);
            }
...
void USBDCDCSerialStateChange(void *pvCDCDevice, uint16_t ui16State) {
    ...
    //
    SetDeferredOpFlag(&psInst->ui16DeferredOpFlags, CDC_DO_SERIAL_STATE_CHANGE, true);
    ...
    if (psInst->iCDCInterruptState == eCDCStateIdle) {
        ...
        //
        psInst->iCDCInterruptState = eCDCStateWaitData;
        SendSerialState((tUSBDCDCDevice *)pvCDCDevice);
    }
